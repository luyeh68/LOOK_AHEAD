...
// header if you need
typedef struct {
  int count_idle; //counter
  int count_run; //counter
} state_data_t;
...
// Transition functions: executed functions only when we are transitioning
void reset(state_data_t *data);

// Table of transition functions
extern transition_func_t *const transition_table[NUM_STATES][NUM_STATES];

// state manager: main interface for running the FSM and it's gonna be used in the Main Function
