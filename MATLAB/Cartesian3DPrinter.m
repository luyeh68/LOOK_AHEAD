...
LAtable.Properties.VariableNames = ["n","timeSpan","t_blk","lambda","s","s1","s2","dt1","dtm","dt2","dt","a","d","fs","fm","fe","feed","l","k","X","Y","Z","travel"];
...
figure(5)
plot(timer, lambda, "LineWidth", 2, "Color", "green")
grid on
xlabel('t [sec]')
ylabel('lambda [ ]')
title('Lambda profile as function of time')
xlim([timer(1) - 0.05, timer(end) + 0.05])
ylim([0, 1])
